...
from doxa.governance.revision.links import PredicateConstraints, PredicateLink, predicate_clauses
from doxa.governance.revision.preference import is_hypothesis, preference_bands, revision_candidates
from doxa.solver import Not, Solver
