...
from doxa.solver.ast.context import global_ctx
from doxa.solver.ast.expr import App, BoundVar, Const, Expr, Quantifier
from doxa.solver.ast.utils import substitute

if TYPE_CHECKING:
    from doxa.solver.theories.euf import EUFSolver
